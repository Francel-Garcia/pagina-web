...
return redirect('/empleados/create')->with('error', 'Cédula ya existe');
       ...
       $existeEmail  = Empleados::where('Email', $request->Email)->first();
       if ($existeEmail != null) {
        return redirect('/empleados/create')->with('error', 'Email ya existe');
   }


   $existeTelefono  = Empleados::where('Telefono', $request->Telefono)->first();
   if ($existeTelefono != null) {
    return redirect('/empleados/create')->with('error', 'Telefono ya existe');
